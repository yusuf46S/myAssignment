...
if page == "Introduction":
  ...
  st.write('The dataset includes information on the games Metacritic score, price, and number of recommendations. Using this data, you can analyze which games are the most popular on Steam and compare their prices and Metacritic scores. You can also use the data to find games that are recommended by other Steam users.Recently some players used to get bored or confused which game to play or invest their time/money in so using the following informations will make the choices easier.')
